...
# Criando janela
tamanho_janela = largura, altura = (400, 400)
...
while True:
    ...
    pygame.draw.circle(janela, preto, (v, posicao_y), raio_circulo)
    pygame.draw.circle(janela, branco, (posicao_x, posicao_y), raio_circulo)
    pygame.display.flip()
